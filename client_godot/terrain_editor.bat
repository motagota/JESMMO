...
rem brush, auto-logged-in as the server-seeded editor account. Everything after
rem Godot's "--" separator reaches Main.gd as a user arg.
...
start "" "%GODOT%" --path "%~dp0." -- --editor-mode
